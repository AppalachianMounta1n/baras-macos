...
use crate::api;
use crate::types::{EffectCategory, EffectListItem, EntityFilter};
        ...
        div { class: "new-effect-form",
            ...
            if !selected_file().is_empty() {
                ...
                div { class: "form-row",
                    ...
                    IdListEditor {
                        ids: effect_ids(),
                        on_change: move |ids| effect_ids.set(ids)
                    }
                }
                ...
                div { class: "form-actions",
                    button {
                        class: "btn-save",
                        // Require name and at least one effect ID or refresh ability
                        disabled: name().is_empty() || (effect_ids().is_empty() && refresh_abilities().is_empty()),
                        onclick: move |_| {
